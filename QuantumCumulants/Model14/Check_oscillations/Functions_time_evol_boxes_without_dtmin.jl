...
function solve_random_distrib(chunk, functs, op_list, N, n, d0_lb, window_t, window_var, threshold_box, f_counter, save_sol)
...
if !isdir("solutions_without_dtmin")
    mkdir("solutions_without_dtmin")
end